...
void testCommandCoding() {
	...
	cout<< "Encoded value " << value << endl <<endl;
	cout << "Decoding value"<<endl;
  ...
  printf("Result: %X\n", operand);
	cout << "Decoding wrong value"<<endl;
	sc_commandDecode(268, &command, &operand);
	sc_regGet(5,&value);
	cout << "Invalid command registr: " << value << endl;
